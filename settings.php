...
$color = $_SESSION['color'] ?? ($theme === 'dark' ? 'dark' : 'light');
?>
<!DOCTYPE html>
<html lang="tr">
<head>
                    ...
                    <form method="post">
                        <div class="mb-3">
                            ...
                            <select id="theme" name="theme" class="form-select">
                                <option value="light" <?php echo $theme === 'light' ? 'selected' : ''; ?>>Açık</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="color" name="color" class="form-select">
                                <?php foreach (['primary','secondary','success','danger','warning','info','light','dark'] as $c): ?>
                                    <option value="<?php echo $c; ?>" <?php echo $color === $c ? 'selected' : ''; ?>><?php echo ucfirst($c); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
