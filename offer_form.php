                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="company_id" class="form-select" required>
                            ...
                            <option value="<?php echo $co['id']; ?>"
                                <?php echo ($quote && $quote['company_id'] == $co['id']) ? 'selected' : ''; ?>>
                                <?php echo htmlspecialchars($co['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="contact_id" class="form-select" required>
                            ...
                            <option value="<?php echo $cu['id']; ?>"
                                <?php echo ($quote && $quote['contact_id'] == $cu['id']) ? 'selected' : ''; ?>>
                                <?php echo htmlspecialchars($cu['name']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="payment_method" class="form-select">
                            ...
                            <option value="<?php echo $method; ?>"
                                <?php echo $current === $method ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="assembly_type" class="form-select">
                            ...
                            <option value="<?php echo $opt; ?>"
                                <?php echo $currentAssembly === $opt ? 'selected' : ''; ?>><?php echo $opt; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                <form class="modal-content" method="post" action="offer_form?id=<?php echo $id; ?>">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="height_mm" id="giyotinHeight"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="system_qty" id="giyotinQty" class="form-control" min="0"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="giyotinSubmit"
                            class="btn btn-<?php echo get_color(); ?>">Ekle</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="dropdown ms-auto">
                ...
                <ul class="dropdown-menu" aria-labelledby="offerDropdown">
                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                            data-bs-target="#giyotinModal">Giyotin</a>
                    </li>
                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#surmeModal">Sürme</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="system_qty" id="surmeQty" class="form-control" min="0"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">RAL Kod</label>
